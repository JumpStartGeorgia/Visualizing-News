...
module BootstrapStarter
  class Application < Rails::Application
    ...
    # config.active_record.observers = :cacher, :garbage_collector, :forum_
		config.active_record.observers = :user_observer, :visualization_observer, :idea_progress_observer, :idea_observer
    ...
    config.assets.precompile += ['fancybox_layout.js', 'fonts_en.css', 'fonts_ka.css']
  end
end
