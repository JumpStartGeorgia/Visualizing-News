...
set :application, "Feradi-Staging" # unique name of application
set :user, "feradi-staging" # name of user on server
...
set :github_repo_name, "feradi.info" # name of git hub repo
set :git_branch_name, "video" # name of branch to deploy
