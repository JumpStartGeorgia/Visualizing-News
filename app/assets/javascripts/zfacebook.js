...
console.log("created fb comment");
				// get id of record
...
console.log("sending notifications for visual comments");
  				$.get(gon.visual_comment_notification_url.replace(gon.placeholder, id));
        } else if (url_ary.indexOf('ideas') > -1){
console.log("sending notifications for idea comments");
