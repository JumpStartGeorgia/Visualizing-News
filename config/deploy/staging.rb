...
set :application, "Visualizing-News-Staging" # unique name of application
set :user, "news-staging" # name of user on server
...
set :github_repo_name, "Visualizing-News" # name of git hub repo
set :git_branch_name, "language" # name of branch to deploy
